...
function Module2({ Item, screenSize, mapZoom, useEffectIf, activeStep, geography, setGeography, codes, setCodes, map, getUniqueFeatures, ecoregions, idList, postalcodes, handleNext }) {
                    ...
                    <Grid container spacing={3}>
                        <Grid item xs={12}>
                                <Item>
                                    ...
                                    Plants in this database support pollinators and are native to specific <a style={{ color: '#6D8764' }}  href="https://open.canada.ca/data/en/dataset/ade80d26-61f5-439e-8966-73b352811fe6" target="_blank">ecoregions in Canada</a>.
